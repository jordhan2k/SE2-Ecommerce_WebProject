...
<body>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Voucher Add</h4>
                  <p class="card-category"> Add a new voucher</p>
                </div>
                <div class="card-body">
                  ...
                  <!-- Start Table -->
							...
							<div class="panel-body">
								<div class="table-responsive">
									...
									<form role="form" action="<c:url value='/admin/voucher/add'/>" method="post"
											...
											<div class="col-md-12">
												<div class="form-group">
													<label class="bmd-label-floating">Voucher Code</label> <input
														type="text" name="voucherCode" class="form-control"
														required="required">
												</div>
											</div>
										...
										<div class="form-group">
											<div class="col-md-6">
												<div class="form-group">
													<label class="bmd-label-floating">Discount %</label> <input
														type="number" min="0" name="discountPercent"
														class="form-control" required="required">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="bmd-label-floating">Expire Date</label> <input
														type="date" name="expireDate" class="form-control"
														required="required">
												</div>
											</div>
										</div>
  ...
  <script>
  	const activeSidebarItem = document.querySelector("#voucher-management");
	activeSidebarItem.classList.add("active");

	const pageName = document.querySelector("#page-name");
	pageName.textContent = "Voucher Management";
