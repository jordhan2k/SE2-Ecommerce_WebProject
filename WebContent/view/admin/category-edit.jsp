...
<body>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Edit category information</p>
                </div>
                <div class="card-body">
                  ...
                  <!-- Start Table -->
							...
							<div class="panel-body">
								<div class="table-responsive">
									<form role="form"
										action="<c:url value='/admin/category/edit'/>" method="post"
										enctype="multipart/form-data">
										<label>Category ID: </label><input name="categoryID" value="${category.categoryID }"
  ...
  <script>
	...
	pageName.textContent = "Category Management";
